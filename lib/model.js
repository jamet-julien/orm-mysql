...
class Model extends EventEmitter{
  ...
  _read( arg, fCall, sLimit = ''){
    var sQuery = `SELECT * FROM ${this.table} WHERE ${this._computeCondition( arg)} ${sLimit}`;
  ...
  save(){
    ...
    delete oData.id;
    delete oData[this.referer];

    return new Promise( (resolve, reject)=>{

      this._query(
                   `UPDATE ?? SET ? WHERE ?? = ?`,
                   [ this.table , oData, this.referer, this[this.referer] ]
                 ).then(( oInfo)=>{
                              resolve( this);
                        }).catch((e)=>{
                          reject(e);
  ...
  destroy(){
    ...
    return new Promise( (resolve, reject)=>{
      ...
      this._query(
                   `DELETE FROM ?? WHERE ?? = ?`,
                   [ this.table , this.referer, this[this.referer] ]
                 ).then(()=>{
  ...
  */
  create( oData){
    ...
    return new Promise( (resolve, reject)=>{
      ...
      this._query( `INSERT INTO ?? SET ?`, [ this.table , oData]).then(( oInfo)=>{
